<!-- Edit shedule -->
<div class="modal fade" id="editshedule<?php echo $row['sheduleid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="editshedule.php?shedule=<?php echo $row['sheduleid']; ?>" enctype="multipart/form-data">
...
<!-- Delete shedule -->
<div class="modal fade" id="deleteshedule<?php echo $row['sheduleid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
                <h3 class="text-center" style="color: #000;"><?php echo $row['shedule_name']; ?></h3>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Close</button>
                <a href="delete_shedule.php?shedule=<?php echo $row['sheduleid']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
                </form>
            </div>
        </div>
        <!-- /.modal-content -->
